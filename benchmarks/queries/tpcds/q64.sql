-- name: Store customers with high catalog spend by income band
-- timeout: 300s
WITH cs_ui AS (
...
cross_sales AS (
    SELECT i_product_name pname, i_item_sk item_sk,
           s_store_name sname, s_zip szip,
           ...
           d1.d_year syear, d2.d_year fsyear, d3.d_year s2year,
           COUNT(*) cnt,
