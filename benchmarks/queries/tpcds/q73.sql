-- name: Customers with store ticket counts between 1 and 5 by household demographics
-- timeout: 60s
...
ORDER BY cnt DESC, c_last_name, c_first_name, c_salutation, c_preferred_cust_flag
LIMIT 1000;
