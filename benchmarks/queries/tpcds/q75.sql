-- name: Sales and returns by item, brand, and category across channels
-- timeout: 120s
WITH all_sales AS (
    ...
    FROM (
        ...
        SELECT d_year, i_brand_id, i_class_id, i_category_id, i_manufact_id,
               ...
               ss_ext_sales_price - COALESCE(sr_return_amt, 0)
        FROM store_sales
        ...
        SELECT d_year, i_brand_id, i_class_id, i_category_id, i_manufact_id,
               ...
               ws_ext_sales_price - COALESCE(wr_return_amt, 0)
        FROM web_sales
