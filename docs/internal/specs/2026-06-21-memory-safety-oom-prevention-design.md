...
- Web interface surfacing of the above, extending the existing web UI (`docs/internal/specs/2026-06-01-sqe-web-ui-design.md`): cluster memory and pressure, per-query memory and spill, admission state.
...
Web interface (extends `docs/internal/specs/2026-06-01-sqe-web-ui-design.md`, rendered from the same data):
...
Adopted for the web interface (built in this spec against the framework from `docs/internal/specs/2026-06-01-sqe-web-ui-design.md`):
...
- Ballista evaluation: `docs/site/book/src/design-notes/ballista-evaluation-learnings.md`
- Lakehouse engine comparison and roadmap: `docs/internal/lakehouse-engine-comparison.md`
- Related specs: `docs/internal/specs/2026-06-01-sqe-web-ui-design.md`, `docs/internal/specs/2026-03-30-error-handling-design.md`, `docs/internal/specs/2026-04-01-scheduling-evolution-design.md`
