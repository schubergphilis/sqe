...
Run: `grep -rnE '—|–|→' README.md nextsteps.md docs/operations.md`
Expected: zero hits in prose.

- [ ] **Step 4: Commit**

```bash
git add README.md nextsteps.md docs/operations.md
