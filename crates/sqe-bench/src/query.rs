...
pub fn parse_query_file(content: &str) -> (String, Vec<String>, u64, String) {
...
/// "q01" → "1", "1" → "1", "q1" → "1"
pub fn normalize_query_id(id: &str) -> String {
...
pub fn prefix_tables(sql: &str, namespace: &str, benchmark: &str) -> String {
